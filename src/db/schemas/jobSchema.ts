...
export const jobPosts = pgTable(
  "job_posts",
  {
    ...
    parentJobId: uuid("parent_job_id").references((): any => jobPosts.id, {
      onDelete: "cascade",
    }), // Links to parent job if this is a recurring instance
...
export const jobPostCareNeedsRelations = relations(
  jobPostCareNeeds,
  ({ one }) => ({
...
export const jobPostLanguagesRelations = relations(
  jobPostLanguages,
  ({ one }) => ({
    jobPost: one(jobPosts, {
...
export const jobPostPreferencesRelations = relations(
  jobPostPreferences,
  ({ one }) => ({
    jobPost: one(jobPosts, {
