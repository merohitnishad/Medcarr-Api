...
export const conversations = pgTable(
  ...
  (table) => ({
    jobApplicationIdIdx: index("conversations_job_application_id_idx").on(
      table.jobApplicationId,
    ),
    jobPosterIdIdx: index("conversations_job_poster_id_idx").on(
      table.jobPosterId,
    ),
    healthcareUserIdIdx: index("conversations_healthcare_user_id_idx").on(
...
export const messages = pgTable(
  ...
  (table) => ({
    ...
    replyToMessageIdIdx: index("messages_reply_to_message_id_idx").on(
