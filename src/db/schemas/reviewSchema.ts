...
export const reviews = pgTable(
  ...
  (table) => ({
    ...
    healthcareProviderIdIdx: index("reviews_healthcare_provider_id_idx").on(
      table.healthcareProviderId,
    ),
    healthcareProfileIdIdx: index("reviews_healthcare_profile_id_idx").on(
    ...
    uniqueJobReview: index("unique_job_review").on(
      table.jobPostId,
      table.reviewerId,
    ),
  }),
...
export const reviewHelpfulVotes = pgTable(
  ...
  (table) => ({
    ...
    uniqueUserReviewVote: index("unique_user_review_vote").on(
      table.reviewId,
      table.userId,
    ),
  }),
...
export const createReviewHelpfulVoteSchema = createInsertSchema(
  reviewHelpfulVotes,
).omit({
  id: true,
  createdAt: true,
