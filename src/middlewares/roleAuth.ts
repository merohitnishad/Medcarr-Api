...
export const requireOrganization = [
  verifyToken,
  requireRole([UserRole.ADMIN, UserRole.ORGANIZATION]),
];
export const requireHealthcare = [
  verifyToken,
  requireRole([UserRole.ADMIN, UserRole.HEALTHCARE]),
];
...
export const requireOrganizationRole = [
  verifyToken,
  requireMinimumRole(UserRole.ORGANIZATION),
];
export const requireHealthcareRole = [
  verifyToken,
  requireMinimumRole(UserRole.HEALTHCARE),
];
export const requireIndividualRole = [
  verifyToken,
  requireMinimumRole(UserRole.INDIVIDUAL),
];

// Specific access patterns for your business logic
export const requireOrganizationOrHealthcare = [
  verifyToken,
  requireRole([UserRole.ADMIN, UserRole.ORGANIZATION, UserRole.HEALTHCARE]),
];
export const requireNonIndividual = [
  verifyToken,
  requireRole([UserRole.ADMIN, UserRole.ORGANIZATION, UserRole.HEALTHCARE]),
];
export const requireNonHealthCareAndAdmin = [
  verifyToken,
  requireRole([UserRole.ORGANIZATION, UserRole.INDIVIDUAL]),
];
export const requireNonHealthCare = [
  verifyToken,
  requireRole([UserRole.ADMIN, UserRole.ORGANIZATION, UserRole.INDIVIDUAL]),
];
...
export const isOrganization = (userRole: string): boolean =>
  userRole === UserRole.ORGANIZATION;
export const isHealthcare = (userRole: string): boolean =>
  userRole === UserRole.HEALTHCARE;
export const isIndividual = (userRole: string): boolean =>
