...
import {
  ...
  export const disputes = pgTable(
    ...
    (table) => ({
      ...
      reportedAgainstIdx: index("disputes_reported_against_idx").on(table.reportedAgainst),
      statusIdx: index("disputes_status_idx").on(table.status),
      disputeNumberIdx: index("disputes_dispute_number_idx").on(table.disputeNumber),
  ...
  export const disputeDocuments = pgTable(
    ...
    (table) => ({
      ...
      uploadedByIdx: index("dispute_documents_uploaded_by_idx").on(table.uploadedBy),
  ...
  export const createDisputeDocumentSchema = createInsertSchema(disputeDocuments).omit({
    id: true,
    uploadedAt: true,
    isActive: true,
    isDeleted: true,
